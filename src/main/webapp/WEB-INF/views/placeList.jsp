    ...
    <div class="row">
        ...
        <section class="col-md-9">
            ...
            <div class="container features">
               ...
               <tr>
<%--                   <td>--%>
<%--                            <img src="${pageContext.request.contextPath}/images/${place.photo}" class="img-fluid" alt="france">--%>
<%--                   </td>--%>
                    <td>
                   ...
                   <td>
                       <form action="${pageContext.request.contextPath}/deletePlace" method="post">
                           <input type="hidden" name="placeId" value="${place.id}">
                           <input type="submit" name="id" class="button" value="Delete">
                       </form>
                   </td>
                   <td>
                       <form action="${pageContext.request.contextPath}/editPlace" method="get">
                           <input type="hidden" name="plId" value="${place.id}">
