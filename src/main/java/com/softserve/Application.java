...
//        RecordDAOImpl recordDAO = new RecordDAOImpl();
        PlanedOutcomeDAOImpl planedDAO = new PlanedOutcomeDAOImpl();
...
//        Category category = new Category("title", "#5479", "short or long description", 1L, 1L);
        ...
        PlanedOutcome planedOutcome = new PlanedOutcome(234.22, LocalDate.parse("1193-03-15"), "mklsdf,d",
                1L, 3L);
       // System.out.println(planedDAO.save(planedOutcome));
      //  System.out.println(planedDAO.getById(1L));
       // System.out.println(planedDAO.getAllByUserId(1L));
//        planedOutcome.setNote("some note");
//        System.out.println(planedDAO.update(1L, planedOutcome));
        System.out.println(planedDAO.delete(1L));
//
